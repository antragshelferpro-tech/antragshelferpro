...
const T = {
  de: {
    ...
    services: [
      ...
      {icon:'🛡️', title:'Versicherung & Finanzierung', desc:'Unabhängige Beratung für Kranken-, Haftpflicht-, Hausrat- und Kfz-Versicherung sowie alle Arten von Finanzierungen. Bester Tarif – kostenlos und unverbindlich.'},
    ...
    pricing: [
      ...
      {title:'Übersetzung', desc:'Albanisch ↔ Deutsch', price:'Auf Anfrage', period:'', features:['Beglaubigte Übersetzung','Urkunden & Verträge','Behördenpost','Express möglich (+50%)','Lieferung PDF & Original']},
      ...
      {title:'Versicherung', desc:'Unabhängige Beratung', price:'Kostenlos', period:'', features:['Unabhängige Beratung','Tarif-Vergleich','KV, Haftpflicht, Hausrat, Kfz','Finanzierungen aller Art','Ohne Verpflichtung']},
    ],
    btnBuchen: 'Buchen →',
  ...
  sq: {
    ...
    services: [
      ...
      {icon:'🛡️', title:'Sigurim & Financim', desc:'Këshilla të pavarura për sigurim shëndetësor, civil, shtëpie dhe automjeti, si dhe të gjitha llojet e financimit. Tarifa më e mirë – falas dhe pa detyrime.'},
    ...
    pricing: [
      ...
      {title:'Sigurim', desc:'Këshilla të pavarura', price:'Falas', period:'', features:['Këshilla të pavarura','Krahasim tarifash','Shëndetësor, civil, shtëpie, auto','Financime të të gjitha llojeve','Pa detyrime']},
    ],
    btnBuchen: 'Rezervo →',
  ...
  en: {
    ...
    services: [
      ...
      {icon:'🛡️', title:'Insurance & Financing', desc:'Independent advice for health, liability, household and car insurance as well as all types of financing. Best rates – free and without obligation.'},
    ...
    pricing: [
      ...
      {title:'Insurance', desc:'Independent consulting', price:'Free', period:'', features:['Independent consulting','Rate comparison','Health, liability, home, car','All types of financing','No obligation']},
    ],
    btnBuchen: 'Book →',
        ...
        <div className="booking-wrapper">
          <div className="booking-info">
            ...
            <div className="contact-links">
              ...
              <a href="https://wa.me/491745156030">💬 WhatsApp</a>
            </div>
          </div>
